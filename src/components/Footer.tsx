...
const Footer: React.FC = () => {
  return (
    <footer>
      <div className="footer-left">© 2026 <span>Saurab Shrestha</span> — Made with ♥ in Nepal</div>
      ...
      <div className="footer-available"><div className="dot"></div>Available for opportunities</div>
    </footer>
  );
};
